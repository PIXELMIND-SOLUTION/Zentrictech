  ...
  return (
    <footer className="relative bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-gray-300 pt-24 pb-12 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-32 left-10 w-32 h-32 bg-[#004787]/10 rounded-full blur-3xl"
      />
      <motion.div
        animate={{ y: [0, 20, 0] }}
        transition={{ duration: 4, repeat: Infinity, delay: 2 }}
        className="absolute bottom-32 right-10 w-40 h-40 bg-[#004787]/10 rounded-full blur-3xl"
      />
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-center gap-3">
                  <item.icon className="h-5 w-5 text-[#004787]" />
          ...
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-[#004787]/20 to-[#004787]/20 rounded-2xl blur-xl" />
            <div className="relative bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-xl bg-[#004787] flex items-center justify-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-gray-900/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#004787] focus:border-transparent"
                    required
                  />
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full py-4 bg-[#004787] text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2"
                >
                  {isSubmitted ? (
                    <>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-8">
              {[
                ...
                { icon: Globe, label: 'Website', color: 'hover:bg-[#004787]' },
              ].map((social, index) => (
                <motion.a
                  key={social.label}
        ...
        <div className="pt-8 border-t border-gray-800/50">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <motion.button
              ...
              className="px-4 py-2 bg-gradient-to-r from-[#004787]/20 to-[#004787]/20 text-[#004787] rounded-xl hover:from-[#004787]/30 hover:to-[#004787]/30 transition-all flex items-center gap-2"
            >
